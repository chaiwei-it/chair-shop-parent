...
public class BaseController {
	...
	public Admin getLoginUser(HttpServletRequest request) {
		...
		Admin admin = (Admin)simpleCacheService.get(OauthContants.ACCESS_TOKEN + access_token.toString());
		return admin;
	}

	// 获取登录用户id
	public String getUserId(HttpServletRequest request) {
//		Admin admin = getLoginUser(request);
//		if(admin != null) {
//			return admin.getId();
//		}
//		return null;
		return Optional.ofNullable((String) request.getAttribute("userId")).orElse("");
	}
