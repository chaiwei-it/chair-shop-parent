...
public enum HttpCode {
     ...
     * 购物车
     */
    CART_ADD_SUCCESS(40001, "添加成功"),
    CART_NUM_LITTLE(40002, "最小为1"),

    /**
     * 购物车
     */
    ORDER_ID_NEVER(50001, "订单ID不能为空"),
    ORDER_WX_FAIL(50002, "微信下单失败"),
    ORDER_NEVER(50003, "订单不存在"),

    BALABCE_NEVER(60001, "余额不足"),
    ;
