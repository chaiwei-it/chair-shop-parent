...
import com.mood.web.RequestDetailsLogger;
import com.mood.web.ResponseDetailsLogger;
import com.mood.web.ServletContextHolder;
...
public class RequestLoggingAspect implements Ordered {
    ...
    @Around(value = "within(com.mood..*) " +
            "&& (@annotation(org.springframework.web.bind.annotation.ResponseBody)" +
            "|| @annotation(org.springframework.web.bind.annotation.RequestMapping)) " +
            "&& @annotation(com.mood.RequestLogging)")
